...
describe('ImmutableForm()', () => {
  it('returns keys generated from values', () => {
    ...
    const { keys } = ImmutableForm(VALUES).read();
  ...
  it('returns init values', () => {
    const VALUES = { username: '' };
    const { values } = ImmutableForm(VALUES).read();
  ...
  it('validates', () => {
    ...
    const VALUES = { username: '' };
    const form = ImmutableForm(VALUES, {
  ...
  it('sets interaction metadata', () => {
    const VALUES = { username: '' };
    const form = ImmutableForm(VALUES).read();
  ...
  describe('during validation', () => {
    it('injects value and values to validator function', () => {
      ...
      const spy = jest.fn();
      const form = ImmutableForm(VALUES, { username: [spy] });
