...
import { Center, Layout, Streched } from './layout';
...
ContentCentered.args = {
  header: <div style={{ background: 'red', height: '100%' }}>Header</div>,
  children: <Center>Content</Center>,
  footer: <div style={{ background: 'red' }}>Footer</div>,
};

export const ContentStreched = Template.bind({});
ContentStreched.args = {
  header: <div style={{ background: 'red', height: '100%' }}>Header</div>,
  children: (
    <Streched>
      <div>First</div>
      ...
      <div>First</div>
      <div>Second</div>
      <div style={{ margin: 'auto 0 0 0' }}>Last</div>
    </Streched>
  ),
  footer: <div style={{ background: 'red' }}>Footer</div>,
};
