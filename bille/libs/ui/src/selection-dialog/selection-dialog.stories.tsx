...
import { SelectionDialogProps } from './selection-dialog';
...
export const Overload = Template.bind({});
Overload.args = {
  children: [
    <SelectionDialogItem key={0}>
      <span>Warsaw</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={1}>
      <span>Poznan</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={2}>
      <span>Zukowo</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={3}>
      <span>0lsztyn</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={4}>
      <span>Gdansk</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={5}>
      <span>Wojciechowice</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={6}>
      <span>Pasym</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={7}>
      <span>Jednorozec</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={8}>
      <span>Krzynowloga</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={9}>
      <span>Ostroleka</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={10}>
      <span>Ostroleka</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={11}>
      <span>Ostroleka</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={12}>
      <span>Ostroleka</span>
    </SelectionDialogItem>,
  ],
  title: 'Choose option',
